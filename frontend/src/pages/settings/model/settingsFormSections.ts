        ...
        controls: [
          {
            ...
            description:
              'Показывается в курсах, комментариях и командных проектах.',
          ...
          },
          {
            ...
            label: 'О себе',
            description:
              'Короткое описание для преподавателей и участников команды.',
            value:
              'Frontend student, интересуюсь UI, архитектурой и продуктовым дизайном.',
          },
        ],
      },
      {
        ...
        controls: [
          {
            ...
            description:
              'Позволяет другим студентам находить тебя для совместной работы.',
            value: true,
          },
          {
            type: 'toggle',
            ...
            description:
              'Открывает ссылки на GitHub и внешние проекты внутри курса.',
            value: true,
          },
          {
            type: 'select',
            ...
            label: 'Язык профиля',
            description:
              'Влияет на шаблонные подписи и системные блоки карточки.',
            value: 'Русский',
    ...
    favorites: [
      {
        ...
        controls: [
          ...
          },
          {
            ...
            description:
              'Закреплённые учебные наборы всегда будут над общим списком.',
            value: true,
          },
        ],
      },
        ...
        controls: [
          {
            ...
            description:
              'Добавляет в избранное лекции и статьи, к которым ты часто возвращаешься.',
            value: false,
          },
          {
            type: 'toggle',
        ...
        controls: [
          {
            ...
            description:
              'События по заданиям, оценкам и расписанию на устройстве.',
            value: true,
          },
          {
            type: 'select',
        ...
        controls: [
          {
            ...
            description:
              'Уведомления перед сдачей задания и при переносе срока.',
            value: true,
          },
          {
            type: 'toggle',
        ...
        controls: [
          {
            ...
            description:
              'Ограничивает видимость карточки за пределами учебной группы.',
            value: 'Только группа',
            options: [
              'Все в организации',
              'Только группа',
      ...
      },
      {
        ...
        controls: [
          ...
          },
          {
            ...
            description:
              'Проверить последние входы и завершить подозрительные сессии.',
        ...
        controls: [
          {
            ...
            description:
              'Кэшировать открытые лекции и документы на устройстве.',
            value: true,
          },
          {
            type: 'select',
            ...
            description:
              'Максимальный объём под временные файлы и офлайн-материалы.',
            value: '2 ГБ',
          ...
          },
          {
            ...
            description:
              'Сохранять промежуточные версии ответов и заданий локально.',
            value: true,
          },
        ],
      },
        ...
        controls: [
          {
            ...
            label: 'Очистить кэш',
            description:
              'Удаляет временные файлы, превью и локальные миниатюры.',
          ...
          },
          {
            ...
            description:
              'Освобождает место, не затрагивая сданные работы и прогресс.',
    ...
    appearance: [
      {
        ...
        controls: [
          ...
          },
          {
            ...
            description:
              'Количество визуального воздуха в карточках и списках.',
            value: 'Средняя',
        ...
        controls: [
          {
            ...
            description:
              'Усиливает визуальные контрасты для ключевых элементов интерфейса.',
            value: false,
          },
          {
            type: 'toggle',
            ...
            description:
              'Сильнее подсвечивать близкие сроки сдачи и важные статусы.',
            value: true,
          },
        ],
      },
        ...
        controls: [
          {
            ...
            description:
              'Краткие выжимки и структурированные заметки по материалам курса.',
            value: true,
          },
          {
            type: 'toggle',
          ...
          },
          {
            ...
            description:
              'Подбирает материалы на основе активности и результатов.',
            value: true,
          },
        ],
      },
        ...
        controls: [
          {
            ...
            description:
              'Делиться оценкой новых функций и качеством экспериментов.',
            value: true,
          },
          {
            type: 'select',
            ...
            description:
              'Сколько нестабильных функций показывать в интерфейсе.',
