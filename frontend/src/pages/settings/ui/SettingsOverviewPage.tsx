...
const ROW_BASE =
  'flex w-full cursor-pointer items-center gap-3.5 border-none bg-transparent px-4 py-3.5 text-left text-inherit transition-[background] duration-150 hover:bg-[rgba(155,232,247,0.08)] dark:hover:bg-[rgba(155,232,247,0.04)]';

const ROW_ICON =
  'grid size-8 flex-shrink-0 place-items-center rounded-lg bg-[rgba(155,232,247,0.12)] text-[#5dc7de]';
      ...
      <div className="mx-auto flex max-w-[600px] flex-col gap-4 px-0 py-2 max-lg:max-w-none max-lg:px-0">
        ...
        <div className={CARD_BASE}>
          ...
          <div className={`${ROW_BASE} cursor-default hover:bg-transparent dark:hover:bg-transparent`}>
            ...
            <button
              type="button"
              className={`relative h-[26px] w-11 flex-shrink-0 cursor-pointer rounded-[13px] border-none p-0 transition-colors duration-200 ${theme === 'dark' ? 'bg-[#5dc7de] dark:bg-[#1d7f95]' : 'bg-[rgba(180,195,210,0.4)] dark:bg-[rgba(60,80,95,0.5)]'}`}
              onClick={toggleTheme}
        ...
        <div className={`${CARD_BASE} ${CARD_LABS}`}>
          <Link to="/settings/labs" className={ROW_BASE}>
            <span className="grid size-8 flex-shrink-0 place-items-center rounded-lg bg-[rgba(93,199,222,0.18)] text-[#3ba8c0]">
