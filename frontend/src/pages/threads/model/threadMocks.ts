...
export const threadMocks: ThreadItem[] = [
  {
    ...
    summary:
      'Тред с вопросами по структуре проекта, FSD и подготовке первого учебного спринта.',
    unreadCount: 3,
  ...
  },
  {
    ...
    summary:
      'Подбор нового визуального ритма, карточек активности и блока достижений пользователя.',
    unreadCount: 0,
  ...
  },
  {
    ...
    summary:
      'Список ручек для профиля, истории действий и будущего подключения реальных тредов.',
    unreadCount: 1,
...
export const threadMocksMap = Object.fromEntries(
  threadMocks.map((thread) => [thread.id, thread]),
