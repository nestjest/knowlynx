...
export const quickAccessWidgetPresets: QuickAccessWidgetPreset[] = [
  {
    ...
    title: 'Расписание',
    description:
      'Перейти к ближайшим занятиям, дедлайнам и синхронизации календаря.',
  },
  {
    id: 'assignments',
    title: 'Домашние задания',
    description:
      'Открыть активные задания и быстро перейти к последней отправке.',
  },
  {
    id: 'materials',
    title: 'Материалы курса',
    description:
      'Собранные лекции, записи вебинаров и методические материалы по предметам.',
  },
  {
    id: 'attendance',
    title: 'Посещаемость',
    description:
      'Проверить пропуски, подтвержденные занятия и текущую посещаемость.',
  },
  {
    id: 'messages',
    title: 'Сообщения',
